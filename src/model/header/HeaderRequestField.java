...
public enum HeaderRequestField implements HeaderField {
    ...
    ACCEPT("Accept"), ACCEPT_CHARSET("Accept-Charset"), ACCEPT_ENCODING(
	    "Accept-Encoding"), ACCEPT_DATETIME("Accept-Datetime"), AUTHORIZATION(
	    "Authorization"), CONNECTION("Connection"), EXPECT("Expect"), FORWARDED(
	    "Forwarded"), FROM("From"), IF_MODIFIED_SINCE("If-Modified-Since"), IF_RANGE(
	    "If-Range"), IF_UNMODIFIED_SINCE("If-Unmodified-Since"), VIA("Via"), WARNING(
	    "Warning");
